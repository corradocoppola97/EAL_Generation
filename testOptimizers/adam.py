...
class Adam(Optimizer):
    ...
    def step(self, closure=None):
        ...
        # print(f"final m_hat: {self.m_hats}")
        return loss
...
def _single_tensor_adam(params: List[Tensor],
    ...
    for i, param in enumerate(params):
        ...
        exp_avg_sq.mul_(beta2).addcmul_(grad, grad.conj(), value=1 - beta2) # v_t
        ...
        m_hat_param = exp_avg / bias_correction1
        m_hats.append(m_hat_param)

        v_hat_param = exp_avg / bias_correction1
        v_hats.append(v_hat_param)
        # print(f"m_hat: {m_hat_param}")
