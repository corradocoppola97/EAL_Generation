...
from linesearchSGD import armijo, armijoGeneralized, armijoGoldstein, armijoGoldstein2
from linesearchSGD import armijoCustomEnforcedCondition, armijoCustomEnforcedReduction, armijoDecreasingZeta
...
for epoch in range(num_epochs):
    ...
    if doLinesearch:
        ...
        if curr_lr * 10 > 1:
            ...
            alfa = curr_lr * 10
        alfa, f_alfa = armijo(f_tilde, criterion, w_before, gamma, direction, gradient_dir, model, dataset, closure)
        curr_lr = alfa
